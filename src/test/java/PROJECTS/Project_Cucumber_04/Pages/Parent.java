...
public class Parent {
    ...
    public void waitUntilVisible(WebElement element){wait.until(ExpectedConditions.visibilityOf(element));}
    ...
    public List<WebElement> waitVisibleListAllElements(List<WebElement> elementList)
    {
